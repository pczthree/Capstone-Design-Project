...
aileron = ct.ControlTools(aileron_out, freq)
elevator = ct.ControlTools(elevator_out, freq)
motor = ct.ControlTools(motor_out, freq)
rudder = ct.ControlTools(rudder_out, freq)
